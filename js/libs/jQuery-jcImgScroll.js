        ...
        return this.each(function () {
            ...
            object = function (length) {
                ...
                this.NumBtnDom = function (list, w, h, l, t) {
                    return "<dl style=\"z-index:11;width:" + w + "px;height:" + h + "px;position:absolute;left:" + 44 + "%;top:" + t + "px;\">" + list + "<dl>";
                };
                this.arrow = function (l, r, w, h, x, y) {
                    return "<em class=\"sPrev\" id=\"sPrev\" style=\"position:absolute;cursor:pointer;z-index:10;width:" + w + "px;height:" + h + "px;left:" + 35 + "%;\"></em><em class=\"sNext\" id=\"sNext\" style=\"position:absolute;cursor:pointer;z-index:10;width:" + w + "px;height:" + h + "px;right:" + 35 + "%;top:" + y + "px;\"></em>";
                };
            ...
            if (options.title) {
                ...
                $("li.select", _SELF).live("mouseover", function () {
                    ...
                    $(this).find("b").show().delay(100).stop().animate({
                        "height": textHeight,
                        "opacity": options.setTitle.opacity
                    }, 150);
                    return false;
                })
